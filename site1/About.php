...
echo "<div id='header'> <a href='localhost'>Добро пожаловать в наш магазин</a> </div>";
echo "<div id='menu'>";
echo "<a href=''>ГЛАВНАЯ&nbsp;&nbsp;&nbsp;&nbsp;</a>";
echo "<a href='about.php'><b>О нашем магазине</b>&nbsp;&nbsp;&nbsp;&nbsp;</a>";
echo "<a href=''>СЕРВИСЫ&nbsp;&nbsp;&nbsp;&nbsp;</a>";
echo "<a href='price.php'>Прайс-лист&nbsp;&nbsp;&nbsp;&nbsp;</a>";
echo "<a href='addtovar.php'>Раздел администратора</a>";
echo "</div>";
echo "<div id='sidebar'>";
...
Этот шаблон очень прост, поэтому, можно перечислить все цвета со всеми оттенками. Давайте выделим некоторые из них: белый, серый, синий, и зеленый. Нельзя сказать, что эти цвета слишком яркие, но и нельзя сказать, что очень  темные, это что-то среднее.
  ...
  <div id='footer'> &copy;2011 Cамый простой шаблон &nbsp;<span class='separator'>|</span>&nbsp;Разработчики </div>
</div>
</body>
</html>";
?>